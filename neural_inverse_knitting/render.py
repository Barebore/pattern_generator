...
flags.DEFINE_integer('width', 20, 'Width output image')
flags.DEFINE_integer('height', 20, 'Height output image')
FLAGS = flags.FLAGS
...
def main(argv):
    ...
    width = FLAGS.width
    height = FLAGS.height
    t_input = tf.placeholder(tf.int32, shape = (batch_size, height, width, 1))
